...
class FilterMixin(object):
    ...
    def get_start_date(self, request, default=None):
        try:
    ...
    def get_end_date(self, request, default=None):
        try:
    ...
    def get_week(self, request, default=0):
        try:
    ...
    def get_name(self, request, default=None):
        return request.GET.get('name', default)

    def get_mask_name(self, request, default=None):
        return request.GET.get('mask_name', default)

    def get_pharmacy_id(self, request, default=None):
        try:
            return int(request.GET.get('pharmacy_id', default))
        except:
            return None

    def get_ordering(self, request, default=None):
        return request.GET.get('ordering', default)

    def get_is_desc(self, request):
        # TODO can be optimized: ordering=price or ordering=-price
        return request.GET.get('is_desc', 'false') in ['true', 'True', '1']

    def get_min_price(self, request, default=None):
        try:
            return int(request.GET.get('min_price', default))
        except:
            return None

    def get_max_price(self, request, default=None):
        try:
